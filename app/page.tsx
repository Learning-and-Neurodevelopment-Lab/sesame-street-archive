            ...
            <div className="w-full max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12">
              <div className="flex-1 text-left">
                ...
                <Button
                  asChild
                  size="lg"
                  className="bg-gray-600 hover:bg-gray-700 text-white font-semibold px-8 py-4"
                >
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                {calloutItems.map((item) => (
                  <div
                    key={item.id}
                    className="aspect-square bg-gray-200 border border-gray-300 flex justify-center"
                  >
                    <Image
                      src={item.image}
                      alt={item.title}
