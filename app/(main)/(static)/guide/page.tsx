    ...
    <div className="max-w-5xl mx-auto px-4 py-12 flex gap-8">
      ...
      <aside className="w-64 flex-shrink-0">
        <nav className="sticky top-20">
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <a href="#introduction" className="block text-neutral-600 hover:text-blue-600 py-1">
                Introduction
              </a>
            </li>
            <li>
              <a href="#search" className="block text-neutral-600 hover:text-blue-600 py-1">
                Searching the Archive
              </a>
            </li>
            <li>
              <a href="#browsing" className="block text-neutral-600 hover:text-blue-600 py-1">
                Browsing by Category
              </a>
            </li>
            <li>
              <a href="#annotations" className="block text-neutral-600 hover:text-blue-600 py-1">
                Annotations & Contributions
              </a>
            </li>
            <li>
              <a href="#faq" className="block text-neutral-600 hover:text-blue-600 py-1">
                FAQ
              </a>
            </li>
          </ul>
      ...
      <div className="flex-1 max-w-3xl">
        ...
        <section id="annotations" className="mb-10 scroll-mt-24">
          <h2 className="text-2xl font-semibold mb-2">Annotations & Contributions</h2>
          <ol className="list-decimal list-inside space-y-2 text-neutral-700">
            <li>
              <strong>View Annotations:</strong> See community notes and trivia on episodes and segments.
            </li>
            <li>
              <strong>Add Your Own:</strong> Contribute facts, corrections, or memories by clicking the "Add Annotation" button.
            </li>
            <li>
              <strong>Moderation:</strong> All contributions are reviewed for accuracy and appropriateness.
            </li>
          </ol>
        </section>
        ...
        <section id="faq" className="mb-10 scroll-mt-24">
          ...
          <div className="space-y-4 text-neutral-700">
            <div>
              ...
              <p>No, this is a research focused resource and is not affiliated with Sesame Workshop.</p>
            </div>
            <div>
              <strong>Can I watch full episodes?</strong>
              <p>Some episodes and segments are available on streaming platforms; others may have summaries or screenshots.</p>
            </div>
            <div>
              <strong>How can I contribute?</strong>
              <p>Register for a free account and use the annotation tools to add or edit information.</p>
            </div>
          </div>
        </section>
      </div>
