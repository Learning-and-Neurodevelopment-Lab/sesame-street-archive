...
export const FetchImageUrls: React.FC<FetchImageUrlsProps> = ({ annotations }) => {
  type AnnotationWithoutIndex = Omit<Schema["Annotation"]["type"], string | number | symbol>;
  const [annotationsWithUrls, setAnnotationsWithUrls] = useState<Array<AnnotationWithoutIndex & { imageUrl?: string }>>([]);
